...
logging.basicConfig(filename='/home/norberteke/PycharmProjects/Thesis/logs/run_optimizer_past_10000.log', format='%(asctime)s : %(levelname)s : %(message)s', level=logging.INFO)
config_path = "/home/norberteke/PycharmProjects/Thesis/data/SO_past_model_parameter_config_log.csv"

#with open(config_path, 'a') as f:
#    writer = csv.writer(f, delimiter=',', quotechar='"', quoting=csv.QUOTE_MINIMAL)
#    writer.writerow("Number_of_topics, Beta, Coherence")
...
res = load('/home/norberteke/PycharmProjects/Thesis/data/SO_past_param_optimizer_checkpoint.pkl')
x0 = res.x_iters
y0 = res.func_vals
