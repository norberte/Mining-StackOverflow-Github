...
logging.basicConfig(filename='/home/norberteke/PycharmProjects/Thesis/logs/run_optimizer_recent_10000.log', format='%(asctime)s : %(levelname)s : %(message)s', level=logging.INFO)
...
checkpoint_saver = CheckpointSaver("/home/norberteke/PycharmProjects/Thesis/data/SO_recent_param_optimizer_checkpoint.pkl", compress=9)

from skopt import load
res = load('/home/norberteke/PycharmProjects/Thesis/data/SO_recent_param_optimizer_checkpoint.pkl')
x0 = res.x_iters
y0 = res.func_vals
...
try:
    dump(res_gp, '/home/norberteke/PycharmProjects/Thesis/data/SO_recent_param_optimizer_result_10000.pkl')
except:
    dump(res_gp,
             '/home/norberteke/PycharmProjects/Thesis/data/SO_recent_param_optimizer_result_without_objective_10000.pkl', store_objective=False)
finally:
    try:
